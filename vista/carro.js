        ...
        // Base de datos de productos. tiene que ser reemplazadaaa
        const productos = {
            'prod-1': {
                id: 'prod-1',
        ...
        function agregarAlCarrito(productoId) {
            ...
            if (existe) {
                ...
                carrito.push({
                    ...producto,
                    cantidad: 1,
                    fecha: new Date().toISOString().split('T')[0] // Fecha actual como default
                });
            }
        ...
        function actualizarCarrito() {
            ...
            carrito.forEach(item => {
                ...
                itemElement.innerHTML = `
                    ...
                    <div class="controles-cantidad">
                        ...
                        <button onclick="cambiarCantidad('${item.id}', 1)">+</button>
                        <button onclick="eliminarDelCarrito('${item.id}')" style="margin-left: auto;">Eliminar</button>
                    </div>
            ...
            totalElement.textContent = `$${subtotal.toFixed(2)}`; // Aquí podrías agregar impuestos/descuentos
        }
        ...
        // Función para actualizar la fecha de una excursión
        ...
        // Función para cargar del localStorage al iniciar
        ...
        window.addEventListener('DOMContentLoaded', () => {
            ...
            // Ocultar datos de tarjeta inicialmente si no es el método seleccionado
